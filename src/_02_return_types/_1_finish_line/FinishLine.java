...
public class FinishLine {
	...
	public static void main(String[] args) {
		...
		if(crossed) {
			JOptionPane.showMessageDialog(null, "The robot finihsed and it went " + distance + " meters far.");
		}
		else {
			JOptionPane.showMessageDialog(null, "The robot did not finish and it went " + distance + " meters far.");
		}
